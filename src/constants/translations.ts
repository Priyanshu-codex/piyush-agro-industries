...
export const PRODUCTS: Product[] = [
  { id: 'tractor-trolley',  icon: '🚜', gradient: 'from-[#065F2E] to-[#0B7A3B]', title: { en: 'Tractor Trolley', hi: 'ट्रैक्टर ट्रॉली' }, desc: { en: 'Heavy-duty agricultural transportation trolley for farms and construction.', hi: 'खेतों और निर्माण के लिए भारी-भरकम कृषि ट्रॉली।' }, category: 'tractor', thumbnail: '/images/products/tractor-trolley.png', images: ['/images/products/tractor-trolley.png', '/images/products/tractor-tipping-trailer.png', '/images/products/2-ton-agriculture-tractor-trailer.png', '/images/products/non-tipping-tractor-trailer.png'], specs: { nameOfPart: 'Tractor Trolley', capacity: '3–10 Ton', size: '10 × 6 × 2 Feet (L × B × H)' } },
  { id: '4w-hydraulic',     icon: '🔧', gradient: 'from-[#1a2f6f] to-[#243B8F]', title: { en: '4-Wheel Hydraulic Trolley', hi: 'चार पहिया हाइड्रोलिक ट्रॉली' }, desc: { en: 'Strong hydraulic lifting system for heavy commercial loads.', hi: 'भारी व्यावसायिक भार के लिए मजबूत हाइड्रोलिक लिफ्टिंग।' }, category: 'hydraulic', thumbnail: '/images/products/4-wheel-hydraulic-trolley.png', images: ['/images/products/4-wheel-hydraulic-trolley.png', '/images/products/hydraulic-trolley.png'], specs: { nameOfPart: '4-Wheel Hydraulic Trolley', capacity: '10–20 Ton', size: '14 × 7 × 3 Feet (L × B × H)' } },
  { id: '2w-hydraulic',     icon: '⚙️', gradient: 'from-[#0d6471] to-[#0e9aad]', title: { en: '2-Wheel Hydraulic Trolley', hi: 'दो पहिया हाइड्रोलिक ट्रॉली' }, desc: { en: 'Cost-effective hydraulic transport solution for farmers.', hi: 'किसानों के लिए किफायती हाइड्रोलिक परिवहन समाधान।' }, category: 'hydraulic', thumbnail: '/images/products/2-wheeler-trolley.png', images: ['/images/products/2-wheeler-trolley.png', '/images/products/hydraulic-trolley.png'], specs: { nameOfPart: '2-Wheel Hydraulic Trolley', capacity: '5–10 Ton', size: '12 × 6 × 2.5 Feet (L × B × H)' } },
  { id: 'hydraulic-dumper', icon: '🚛', gradient: 'from-[#b45309] to-[#d97706]', title: { en: 'Hydraulic Dumper', hi: 'हाइड्रोलिक डम्पर' }, desc: { en: 'High-capacity hydraulic dumper for farming and construction.', hi: 'खेती और निर्माण के लिए उच्च क्षमता हाइड्रोलिक डम्पर।' }, category: 'hydraulic', thumbnail: '/images/products/hydraulic-dumper.png', images: ['/images/products/hydraulic-dumper.png'], specs: { nameOfPart: 'Hydraulic Dumper', capacity: '10–25 Ton', size: '16 × 7 × 4 Feet (L × B × H)' } },
  { id: 'water-tanker',     icon: '💧', gradient: 'from-[#0c4a6e] to-[#0ea5e9]', title: { en: 'Water Tanker Trailer', hi: 'वाटर टैंकर ट्रेलर' }, desc: { en: 'Reliable water transportation tanker for various uses.', hi: 'विभिन्न उपयोगों के लिए विश्वसनीय जल टैंकर ट्रेलर।' }, category: 'water', thumbnail: '/images/products/water-tanker.png', images: ['/images/products/water-tanker.png', '/images/products/mini-water-tank-trolley.png'], specs: { nameOfPart: 'Water Tanker Trailer', capacity: '3000–5000 Liters', size: '10 × 5 × 5 Feet (L × B × H)' } },
  { id: 'medical-vehicle',  icon: '🚑', gradient: 'from-[#991b1b] to-[#dc2626]', title: { en: 'Medical Vehicle', hi: 'मेडिकल वाहन' }, desc: { en: 'Customized medical and utility vehicles for healthcare.', hi: 'स्वास्थ्य सेवा के लिए कस्टमाइज़ मेडिकल वाहन।' }, category: 'fabrication', thumbnail: '/images/products/medical-vehicle.png', images: ['/images/products/medical-vehicle.png'], specs: { nameOfPart: 'Medical Vehicle', capacity: 'As per chassis', size: 'Custom Built' } },
  { id: 'garbage-vehicle',  icon: '🗑️', gradient: 'from-[#374151] to-[#4b5563]', title: { en: 'Garbage Collection Vehicle', hi: 'कचरा संग्रह वाहन' }, desc: { en: 'Municipal and commercial garbage collection with durable build.', hi: 'टिकाऊ निर्माण के साथ नगर व व्यावसायिक कचरा वाहन।' }, category: 'fabrication', thumbnail: '/images/products/wheeled-cart.png', images: ['/images/products/wheeled-cart.png'], specs: { nameOfPart: 'Garbage Collection Vehicle', capacity: '2–5 Ton / 3–6 CBM', size: 'Custom Built' } },
  { id: 'agri-equipment',   icon: '🌾', gradient: 'from-[#365314] to-[#4d7c0f]', title: { en: 'Agricultural Equipment', hi: 'कृषि उपकरण' }, desc: { en: 'Complete range of farming equipment for modern agriculture.', hi: 'आधुनिक खेती के लिए कृषि उपकरणों की पूरी रेंज।' }, category: 'agri', thumbnail: '/images/products/agri-equipment.png', images: ['/images/products/agri-equipment.png'], specs: { nameOfPart: 'Agricultural Implements', capacity: 'Varies', size: 'Various Sizes' } },
  { id: 'gates',            icon: '🚪', gradient: 'from-[#1e3a5f] to-[#374151]', title: { en: 'Gates', hi: 'गेट' }, desc: { en: 'Custom fabricated steel gates for residential and commercial use.', hi: 'आवासीय और व्यावसायिक उपयोग के लिए कस्टम स्टील गेट।' }, category: 'fabrication', thumbnail: '/images/products/gates.png', images: ['/images/products/gates.png'], specs: { nameOfPart: 'Steel Gate', capacity: 'N/A', size: 'Custom Dimensions' } },
  { id: 'railings',         icon: '🛡️', gradient: 'from-[#111827] to-[#1f2937]', title: { en: 'Railings', hi: 'रेलिंग' }, desc: { en: 'Strong and decorative railings for safety and aesthetics.', hi: 'सुरक्षा और सौंदर्य के लिए मजबूत और सजावटी रेलिंग।' }, category: 'fabrication', thumbnail: '/images/products/railings.png', images: ['/images/products/railings.png'], specs: { nameOfPart: 'Steel/Iron Railing', capacity: 'N/A', size: 'Custom Dimensions' } },
  { id: 'cultivators',      icon: '🌱', gradient: 'from-[#78350f] to-[#92400e]', title: { en: 'Cultivators', hi: 'कल्टीवेटर' }, desc: { en: 'Durable cultivators for modern and efficient farming.', hi: 'आधुनिक और कुशल खेती के लिए टिकाऊ कल्टीवेटर।' }, category: 'agri', thumbnail: '/images/products/agri-equipment.png', images: ['/images/products/agri-equipment.png'], specs: { nameOfPart: 'Cultivator', capacity: '7-11 Tynes', size: 'Standard' } },
  { id: 'custom-fab',       icon: '🔨', gradient: 'from-[#4c1d95] to-[#6d28d9]', title: { en: 'Custom Fabrication', hi: 'कस्टम फेब्रिकेशन' }, desc: { en: 'Tailor-made fabrication as per customer requirements.', hi: 'ग्राहकों की आवश्यकताओं के अनुसार कस्टम फेब्रिकेशन।' }, category: 'fabrication', thumbnail: '/images/products/fabrication.png', images: ['/images/products/fabrication.png', '/images/products/customize-low-bed-trolley.png'], specs: { nameOfPart: 'Custom Structure', capacity: 'As Required', size: 'As Required' } },
  { id: 'vehicle-repair',   icon: '🔩', gradient: 'from-[#7f1d1d] to-[#b91c1c]', title: { en: 'Vehicle Repairing', hi: 'वाहन मरम्मत' }, desc: { en: 'Repair and maintenance of all agricultural and commercial vehicles.', hi: 'सभी प्रकार के कृषि और व्यावसायिक वाहनों की मरम्मत।' }, category: 'fabrication', thumbnail: '/images/products/fabrication.png', images: ['/images/products/fabrication.png'], specs: { nameOfPart: 'Repair Service', capacity: 'All Vehicles', size: 'N/A' } },
];

export const GALLERY_ITEMS: GalleryItem[] = [
  { id: 'g1', icon: '🔧', gradient: 'from-[#1a2f6f] to-[#243B8F]', label: { en: '4-Wheel Hydraulic Trolley', hi: 'चार पहिया हाइड्रोलिक ट्रॉली' }, category: 'hydraulic', imageUrl: '/images/products/4-wheel-hydraulic-trolley.png' },
  { id: 'g2', icon: '⚙️', gradient: 'from-[#0d6471] to-[#0e9aad]', label: { en: '2-Wheel Hydraulic Trolley', hi: 'दो पहिया हाइड्रोलिक ट्रॉली' }, category: 'hydraulic', imageUrl: '/images/products/2-wheeler-trolley.png' },
  { id: 'g3', icon: '🚜', gradient: 'from-[#065F2E] to-[#0B7A3B]', label: { en: 'Tractor Trolley', hi: 'ट्रैक्टर ट्रॉली' }, category: 'tractor', imageUrl: '/images/products/tractor-trolley.png' },
  { id: 'g4', icon: '🌾', gradient: 'from-[#365314] to-[#4d7c0f]', label: { en: 'Agricultural Trolley', hi: 'कृषि ट्रॉली' }, category: 'tractor', imageUrl: '/images/products/2-ton-agriculture-tractor-trailer.png' },
  { id: 'g5', icon: '💧', gradient: 'from-[#0c4a6e] to-[#0ea5e9]', label: { en: 'Water Tanker Trailer', hi: 'वाटर टैंकर ट्रेलर' }, category: 'water', imageUrl: '/images/products/water-tanker.png' },
  { id: 'g6', icon: '🚛', gradient: 'from-[#b45309] to-[#d97706]', label: { en: 'Hydraulic Dumper', hi: 'हाइड्रोलिक डम्पर' }, category: 'hydraulic', imageUrl: '/images/products/hydraulic-dumper.png' },
  { id: 'g7', icon: '🌱', gradient: 'from-[#78350f] to-[#92400e]', label: { en: 'Cultivator', hi: 'कल्टीवेटर' }, category: 'agri', imageUrl: '/images/products/agri-equipment.png' },
  { id: 'g8', icon: '🔨', gradient: 'from-[#4c1d95] to-[#6d28d9]', label: { en: 'Custom Fabrication', hi: 'कस्टम फेब्रिकेशन' }, category: 'fabrication', imageUrl: '/images/products/fabrication.png' },
  { id: 'g9', icon: '🚪', gradient: 'from-[#1e3a5f] to-[#374151]', label: { en: 'Steel Gate', hi: 'स्टील गेट' }, category: 'fabrication', imageUrl: '/images/products/gates.png' },
  { id: 'g10',icon: '🛡️', gradient: 'from-[#111827] to-[#1f2937]', label: { en: 'Railings', hi: 'रेलिंग' }, category: 'fabrication', imageUrl: '/images/products/railings.png' },
  { id: 'g11',icon: '⚙️', gradient: 'from-[#065F2E] to-[#14a050]', label: { en: 'Agricultural Equipment', hi: 'कृषि उपकरण' }, category: 'agri', imageUrl: '/images/products/agri-equipment.png' },
  { id: 'g12',icon: '🔩', gradient: 'from-[#7f1d1d] to-[#b91c1c]', label: { en: 'Workshop / Repair', hi: 'कार्यशाला / मरम्मत' }, category: 'fabrication', imageUrl: '/images/products/fabrication.png' },
];
...
export const MEGA_MENU = [
  {
    ...
    items: [
      { id: 'tt-hydraulic', en: 'Hydraulic Tractor Trailer', hi: 'हाइड्रोलिक ट्रैक्टर ट्रेलर' },
      { id: 'tt-tipping', en: 'Tractor Tipping Trailer', hi: 'ट्रैक्टर टिपिंग ट्रेलर' },
      { id: 'tt-5ton', en: '5 Ton Agricultural Tractor Trailer', hi: '5 टन कृषि ट्रैक्टर ट्रेलर' },
      { id: 'tt-2ton', en: '2 Ton Agriculture Tractor Trailer', hi: '2 टन कृषि ट्रैक्टर ट्रेलर' },
      { id: 'tt-nontipping', en: 'Non Tipping Tractor Trailers', hi: 'नॉन टिपिंग ट्रैक्टर ट्रेलर' },
    ]
  },
  {
    title: { en: 'Hydraulic Tractor Trolley', hi: 'हाइड्रोलिक ट्रैक्टर ट्रॉली' },
    items: [
      { id: 'ht-trolley', en: 'Hydraulic Tractor Trolley', hi: 'हाइड्रोलिक ट्रैक्टर ट्रॉली' },
      { id: 'ht-special', en: 'Special Tractor Trolley', hi: 'स्पेशल ट्रैक्टर ट्रॉली' },
      { id: 'ht-water', en: 'Mini Water Tank Trolley', hi: 'मिनी वाटर टैंक ट्रॉली' },
    ]
  },
  {
    title: { en: 'Generator Trolley', hi: 'जनरेटर ट्रॉली' },
    items: [
      { id: 'gt-4wheel', en: '4 Wheel Generator Trolley', hi: '4 व्हील जनरेटर ट्रॉली' },
      { id: 'gt-set', en: 'Generator Set Trolley', hi: 'जनरेटर सेट ट्रॉली' },
      { id: 'gt-2wheel', en: '2 Wheeler Trolley', hi: '2 व्हीलर ट्रॉली' },
      { id: 'gt-standard', en: 'Generator Trolley', hi: 'जनरेटर ट्रॉली' },
    ]
  },
  {
    title: { en: 'Material Handling Equipment', hi: 'मटेरियल हैंडलिंग उपकरण' },
    items: [
      { id: 'mh-ugpu', en: 'UGPU Trolley 4 Wheel', hi: 'UGPU ट्रॉली 4 व्हील' },
      { id: 'mh-lowbed', en: 'Customize Low Bed Trailer', hi: 'कस्टमाइज लो बेड ट्रेलर' },
      { id: 'mh-lowbedtrolley', en: 'Customize Low Bed Trolley', hi: 'कस्टमाइज लो बेड ट्रॉली' },
      { id: 'mh-cart', en: 'Wheeled Cart', hi: 'पहिएदार गाड़ी' },
    ]
  }
];
...
export const EXTENDED_PRODUCTS: Product[] = [
  // Tractor Trailers
  { id: 'tt-hydraulic', icon: '🚜', gradient: 'from-[#065F2E] to-[#0B7A3B]', category: 'Tractor Trailers', title: { en: 'Hydraulic Tractor Trailer', hi: 'हाइड्रोलिक ट्रैक्टर ट्रेलर' }, desc: { en: 'Heavy-duty hydraulic trailer for agricultural transport.', hi: 'कृषि परिवहन के लिए भारी हाइड्रोलिक ट्रेलर।' }, thumbnail: '/images/products/4-wheel-hydraulic-trolley.png', images: ['/images/products/4-wheel-hydraulic-trolley.png'], specs: { nameOfPart: 'Hydraulic Trailer', capacity: '5–15 Ton', size: '12 × 6 × 3 Feet' } },
  { id: 'tt-tipping', icon: '🚜', gradient: 'from-[#0d6471] to-[#0e9aad]', category: 'Tractor Trailers', title: { en: 'Tractor Tipping Trailer', hi: 'ट्रैक्टर टिपिंग ट्रेलर' }, desc: { en: 'Tipping mechanism for easy unloading of materials.', hi: 'सामग्री आसानी से उतारने के लिए टिपिंग तंत्र।' }, thumbnail: '/images/products/tractor-tipping-trailer.png', images: ['/images/products/tractor-tipping-trailer.png'], specs: { nameOfPart: 'Tipping Trailer', capacity: '3–10 Ton', size: '10 × 6 × 2.5 Feet' } },
  { id: 'tt-5ton', icon: '🚜', gradient: 'from-[#1a2f6f] to-[#243B8F]', category: 'Tractor Trailers', title: { en: '5 Ton Agricultural Tractor Trailer', hi: '5 टन कृषि ट्रैक्टर ट्रेलर' }, desc: { en: 'Standard 5 ton capacity trailer for general farming needs.', hi: 'सामान्य खेती के लिए मानक 5 टन क्षमता ट्रेलर।' }, thumbnail: '/images/products/tractor-trolley.png', images: ['/images/products/tractor-trolley.png'], specs: { nameOfPart: 'Agri Trailer', capacity: '5 Ton', size: '11 × 6 × 2 Feet' } },
  { id: 'tt-2ton', icon: '🚜', gradient: 'from-[#b45309] to-[#d97706]', category: 'Tractor Trailers', title: { en: '2 Ton Agriculture Tractor Trailer', hi: '2 टन कृषि ट्रैक्टर ट्रेलर' }, desc: { en: 'Lightweight trailer for small farms and narrow paths.', hi: 'छोटे खेतों और संकरे रास्तों के लिए हल्का ट्रेलर।' }, thumbnail: '/images/products/2-ton-agriculture-tractor-trailer.png', images: ['/images/products/2-ton-agriculture-tractor-trailer.png'], specs: { nameOfPart: 'Mini Trailer', capacity: '2 Ton', size: '8 × 5 × 1.5 Feet' } },
  { id: 'tt-nontipping', icon: '🚜', gradient: 'from-[#374151] to-[#4b5563]', category: 'Tractor Trailers', title: { en: 'Non Tipping Tractor Trailers', hi: 'नॉन टिपिंग ट्रैक्टर ट्रेलर' }, desc: { en: 'Fixed bed tractor trailers for stable transport.', hi: 'स्थिर परिवहन के लिए फिक्स्ड बेड ट्रैक्टर ट्रेलर।' }, thumbnail: '/images/products/non-tipping-tractor-trailer.png', images: ['/images/products/non-tipping-tractor-trailer.png'], specs: { nameOfPart: 'Fixed Trailer', capacity: '5–12 Ton', size: '12 × 6 × 2 Feet' } },

  // Hydraulic Tractor Trolley
  { id: 'ht-trolley', icon: '🔧', gradient: 'from-[#065F2E] to-[#0B7A3B]', category: 'Hydraulic Tractor Trolley', title: { en: 'Hydraulic Tractor Trolley', hi: 'हाइड्रोलिक ट्रैक्टर ट्रॉली' }, desc: { en: 'Classic hydraulic trolley for multi-purpose farming use.', hi: 'बहुउद्देशीय खेती के उपयोग के लिए क्लासिक हाइड्रोलिक ट्रॉली।' }, thumbnail: '/images/products/hydraulic-trolley.png', images: ['/images/products/hydraulic-trolley.png'], specs: { nameOfPart: 'Hydraulic Trolley', capacity: '5–10 Ton', size: '10 × 6 × 2.5 Feet' } },
  { id: 'ht-special', icon: '⚙️', gradient: 'from-[#1e3a5f] to-[#374151]', category: 'Hydraulic Tractor Trolley', title: { en: 'Special Tractor Trolley', hi: 'स्पेशल ट्रैक्टर ट्रॉली' }, desc: { en: 'Customized trolley with enhanced heavy-duty chassis.', hi: 'उन्नत भारी-भरकम चेसिस के साथ कस्टमाइज़ ट्रॉली।' }, thumbnail: '/images/products/special-tractor-trolley.png', images: ['/images/products/special-tractor-trolley.png'], specs: { nameOfPart: 'Special Trolley', capacity: '10–15 Ton', size: '12 × 6 × 3 Feet' } },
  { id: 'ht-water', icon: '💧', gradient: 'from-[#0c4a6e] to-[#0ea5e9]', category: 'Hydraulic Tractor Trolley', title: { en: 'Mini Water Tank Trolley', hi: 'मिनी वाटर टैंक ट्रॉली' }, desc: { en: 'Compact water tank trolley for agricultural irrigation.', hi: 'कृषि सिंचाई के लिए मिनी वाटर टैंक ट्रॉली।' }, thumbnail: '/images/products/mini-water-tank-trolley.png', images: ['/images/products/mini-water-tank-trolley.png'], specs: { nameOfPart: 'Water Trolley', capacity: '2000 Liters', size: '8 × 4 × 4 Feet' } },

  // Generator Trolley
  { id: 'gt-4wheel', icon: '⚡', gradient: 'from-[#1a2f6f] to-[#243B8F]', category: 'Generator Trolley', title: { en: '4 Wheel Generator Trolley', hi: '4 व्हील जनरेटर ट्रॉली' }, desc: { en: 'Stable 4-wheel base for heavy generator sets.', hi: 'भारी जनरेटर सेट के लिए स्थिर 4-व्हील बेस।' }, thumbnail: '/images/products/generator-trolley.png', images: ['/images/products/generator-trolley.png'], specs: { nameOfPart: '4W Gen Trolley', capacity: '1–5 Ton', size: 'Custom Built' } },
  { id: 'gt-set', icon: '⚡', gradient: 'from-[#78350f] to-[#92400e]', category: 'Generator Trolley', title: { en: 'Generator Set Trolley', hi: 'जनरेटर सेट ट्रॉली' }, desc: { en: 'Enclosed trolley designed for protecting generator sets.', hi: 'जनरेटर सेट की सुरक्षा के लिए डिज़ाइन की गई ट्रॉली।' }, thumbnail: '/images/products/generator-trolley.png', images: ['/images/products/generator-trolley.png'], specs: { nameOfPart: 'Gen Set Trolley', capacity: 'Varies', size: 'Custom Built' } },
  { id: 'gt-2wheel', icon: '⚡', gradient: 'from-[#b45309] to-[#d97706]', category: 'Generator Trolley', title: { en: '2 Wheeler Trolley', hi: '2 व्हीलर ट्रॉली' }, desc: { en: 'Compact 2-wheel trolley for portable generators.', hi: 'पोर्टेबल जनरेटर के लिए कॉम्पैक्ट 2-व्हील ट्रॉली।' }, thumbnail: '/images/products/2-wheeler-trolley.png', images: ['/images/products/2-wheeler-trolley.png'], specs: { nameOfPart: '2W Gen Trolley', capacity: '0.5–1.5 Ton', size: 'Custom Built' } },
  { id: 'gt-standard', icon: '⚡', gradient: 'from-[#374151] to-[#4b5563]', category: 'Generator Trolley', title: { en: 'Generator Trolley', hi: 'जनरेटर ट्रॉली' }, desc: { en: 'Standard trolley for medium size generator transport.', hi: 'मध्यम आकार के जनरेटर परिवहन के लिए मानक ट्रॉली।' }, thumbnail: '/images/products/generator-trolley.png', images: ['/images/products/generator-trolley.png'], specs: { nameOfPart: 'Gen Trolley', capacity: '1–3 Ton', size: 'Custom Built' } },

  // Material Handling Equipment
  { id: 'mh-ugpu', icon: '🏗️', gradient: 'from-[#991b1b] to-[#dc2626]', category: 'Material Handling Equipment', title: { en: 'UGPU Trolley 4 Wheel', hi: 'UGPU ट्रॉली 4 व्हील' }, desc: { en: 'Specialized 4-wheel material handling trolley for industrial use.', hi: 'औद्योगिक उपयोग के लिए विशेष सामग्री हैंडलिंग ट्रॉली।' }, thumbnail: '/images/products/customize-low-bed-trolley.png', images: ['/images/products/customize-low-bed-trolley.png'], specs: { nameOfPart: 'UGPU Trolley', capacity: '2–5 Ton', size: 'Custom Built' } },
  { id: 'mh-lowbed', icon: '🏗️', gradient: 'from-[#4c1d95] to-[#6d28d9]', category: 'Material Handling Equipment', title: { en: 'Customize Low Bed Trailer', hi: 'कस्टमाइज लो बेड ट्रेलर' }, desc: { en: 'Low bed trailer for easy loading of heavy machinery.', hi: 'भारी मशीनरी को आसानी से लादने के लिए लो बेड ट्रेलर।' }, thumbnail: '/images/products/customize-low-bed-trolley.png', images: ['/images/products/customize-low-bed-trolley.png'], specs: { nameOfPart: 'Low Bed Trailer', capacity: '10–30 Ton', size: 'Custom Dimensions' } },
  { id: 'mh-lowbedtrolley', icon: '🏗️', gradient: 'from-[#0d6471] to-[#0e9aad]', category: 'Material Handling Equipment', title: { en: 'Customize Low Bed Trolley', hi: 'कस्टमाइज लो बेड ट्रॉली' }, desc: { en: 'Low height trolley for versatile material handling.', hi: 'बहुमुखी सामग्री हैंडलिंग के लिए कम ऊंचाई वाली ट्रॉली।' }, thumbnail: '/images/products/customize-low-bed-trolley.png', images: ['/images/products/customize-low-bed-trolley.png'], specs: { nameOfPart: 'Low Bed Trolley', capacity: '5–15 Ton', size: 'Custom Dimensions' } },
  { id: 'mh-cart', icon: '🛒', gradient: 'from-[#365314] to-[#4d7c0f]', category: 'Material Handling Equipment', title: { en: 'Wheeled Cart', hi: 'पहिएदार गाड़ी' }, desc: { en: 'Heavy-duty wheeled cart for warehouse and factory floor.', hi: 'गोदाम और कारखाने के लिए भारी पहिएदार गाड़ी।' }, thumbnail: '/images/products/wheeled-cart.png', images: ['/images/products/wheeled-cart.png'], specs: { nameOfPart: 'Wheeled Cart', capacity: '0.5–2 Ton', size: '4 × 3 × 3 Feet' } },
];
