...
export default function Header() {
  ...
  /* ΓöÇΓöÇ Scroll behaviour ΓöÇΓöÇ */
  useEffect(() => {
  ...
  /* ΓöÇΓöÇ Active section tracker ΓöÇΓöÇ */
  useEffect(() => {
    if (pathname !== '/') {
  ...
  /* ΓöÇΓöÇ Prevent body scroll when mobile menu open ΓöÇΓöÇ */
  useEffect(() => {
        ...
        <div className={`bg-primary-dark text-white text-xs hidden sm:block transition-all duration-300 overflow-hidden ${
          ...
          <div className="max-w-7xl mx-auto px-4 flex flex-wrap justify-between items-center gap-2">
            <span className="opacity-90 flex items-center gap-1.5">
              <span>≡ƒôì</span> Khairagarh Road, Thelkadih, Rajnandgaon, CG
            </span>
