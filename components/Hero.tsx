...
import { FLOATING_ICONS } from '@/lib/floatingIcons';
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none overflow-hidden z-0">
        <span className="text-[10vw] font-bold text-white/[0.025] whitespace-nowrap font-rajdhani tracking-widest select-none">
          पियूष एग्रो
        </span>
      </div>
          ...
          <div className="hidden lg:block z-10">
            <div className="grid grid-cols-2 gap-3">
              {HERO_PRODUCTS.map((p, i) => (
                ...
                >
                  <div className="text-4xl mb-2 select-none">{p.icon}</div>
